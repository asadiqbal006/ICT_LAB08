...
3) After that you are ready to run that wbsite locally on your system by using this command( python -m uvicorn main:app --reload)
4)After that ther would be link given in your console, click on that console to run your website
